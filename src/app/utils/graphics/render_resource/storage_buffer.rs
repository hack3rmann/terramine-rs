...
use {
    ...
    wgpu::{util::BufferInitDescriptor, BindingResource, BufferBinding, BufferUsages},
};
...
assert_impl_all!(StorageBuffer<f32>: Send, Sync);
...
assert_impl_all!(DynamicStorageBuffer<f32>: Send, Sync);
