use {
    math_linear::prelude::*,
    noise::{Fbm, Perlin, utils::{PlaneMapBuilder, NoiseMapBuilder, NoiseMap}},
};
...
impl Noise2d {
    pub fn new(seed: u32, sizes: USize2, frequency: f32, lacunarity: f32, n_octaves: usize, persistence: f32) -> Self {
        let fbm = {
